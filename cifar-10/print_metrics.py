...
experiments_path = os.getcwd() + "/cifar10_attention_runs"
...
# Run python3 print_metrics.py --experiment_id 3 on the terminal to print out the training process of run 3
